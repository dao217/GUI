...
{
	ShadersProgramSource source = ParseShader(filepath);
...
ShadersProgramSource Shader::ParseShader(const std::string& filepath)
{
...
unsigned int Shader::CompileShader(unsigned int type, const std::string& source)
{
	...
	if (result == GL_FALSE)
	{
		...
		std::cout << "Filed to compile " << (type == GL_VERTEX_SHADER ? "vertex" : "frament") << " shader" << std::endl;
...
void Shader::SetUnformMat4f(const std::string & name, const glm::mat4 & matrix)
{
